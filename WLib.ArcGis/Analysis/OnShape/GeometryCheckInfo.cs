...
namespace WLib.ArcGis.Analysis.OnShape
{
    ...
    public class GeometryCheckInfo
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static GeometryCheckInfo[] GeometryCheckInfos = new GeometryCheckInfo[]
        {
            ...
            new GeometryCheckInfo(esriNonSimpleReasonEnum.esriNonSimpleMismatchedAttributes,"Mismatched Attributes", "M/Z值不匹配","某线段端点的Z坐标或M坐标与下一条线段中与之重合的端点的Z坐标或M坐标不匹配"),
        ...
        public static GeometryCheckInfo GetGeometryCheckInfo(esriNonSimpleReasonEnum eType)
            => GeometryCheckInfos.FirstOrDefault(v => v.eType == eType);
    }
}
