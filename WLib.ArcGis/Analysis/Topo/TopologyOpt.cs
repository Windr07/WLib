    ...
    public class TopologyOpt
    {
      ...
      /// <summary>
        ...
        public static List<string> GetAllTopoNames(IWorkspace workspace)
        {
            ...
            var featureDatasets = WorkspaceOpt.GetFeatureDatasets(workspace);
        ...
        public static ITopology GetTopologyByName(IFeatureWorkspace featureWorkspace, string topoName)
        {
            ...
            var featureDatasets = WorkspaceOpt.GetFeatureDatasets(featureWorkspace as IWorkspace);
            foreach (var ds in featureDatasets)
            {
        ...
        {
            List<ITopology> result = new List<ITopology>();
            var featureDatasetList = WorkspaceOpt.GetFeatureDatasets(workspace);
        ...
        {
            int typeIndex = FieldOpt.AddField(resultFeatureClass, "TRuleType", "拓扑规则", esriFieldType.esriFieldTypeInteger);
            int orClassIdIndex = FieldOpt.AddField(resultFeatureClass, "OriClsID", "源要素类ID", esriFieldType.esriFieldTypeInteger);
            int deClassIdIndex = FieldOpt.AddField(resultFeatureClass, "DesClsID", "目标要素类ID", esriFieldType.esriFieldTypeInteger);
            int orOidIndex = FieldOpt.AddField(resultFeatureClass, "OriOID", "源要素OID", esriFieldType.esriFieldTypeInteger);
            int deOidIndex = FieldOpt.AddField(resultFeatureClass, "DesOID", "目标要素OID", esriFieldType.esriFieldTypeInteger);
