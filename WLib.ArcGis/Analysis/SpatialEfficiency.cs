...
namespace WLib.ArcGis.Analysis
{
    ...
    public class SpatialEfficiency
    {
        ...
        {
            //填充Spatial Cache
            ISpatialCacheManager spatialCacheManager = (ISpatialCacheManager)(featureClass as IDataset).Workspace;
            IEnvelope cacheExtent = (featureClass as IGeoDataset).Extent;
            //检测是否存在缓存
