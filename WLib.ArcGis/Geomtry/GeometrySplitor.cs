...
namespace WLib.ArcGis.Geomtry
{
    ...
    public class GeometrySplitor
    {
        ...
        //public static void SplitPolygonByAreaRate(IFeature feature, double[] rates)
        //{
        //    var sumRate = rates.Sum();//分割占比的和
        //    var polygon = feature.ShapeCopy as IPolygon;
        //    var sumArea = (polygon as IArea).Area;//被分割的多边形的面积
        //    var points = GeometryEx.GetPointList(polygon);
        //    int middlePtIndex = points.Count / 2;
        //    IPoint pt0 = points[0];

        //    for (int i = 0; i < rates.Length; i++)
        //    {
        //        double rate = rates[i] / sumRate;
        //        double rateArea = rate * sumArea;

        //    }

        //}
        //public static void SplitPolygonByAreaRate(IFeature feature, List<IPoint> points, double rateArea)
        //{
        //    int curIndex = points.Count / 2;//当前点序

        //    IFeatureEdit pFeatureEdit = feature as IFeatureEdit;
        //    var polyline = CreateGeometry.CreatePolyline(new IPoint[] { points[0], points[curIndex] });
        //    ISet set = pFeatureEdit.Split(polyline);//直接用线分割
        //    var newPolygon = GetFirstSplitPolygon(set);
        //    var area = (newPolygon as IArea).Area;
        //    if (area - rateArea > 0)
        //    {
        //        polyline = CreateGeometry.CreatePolyline(new IPoint[] { points[0], points[curIndex - 1] });

        //    }

        //}
        //private static IPolygon GetFirstSplitPolygon(ISet set)
        //{
        //    IPolygon poygon = null;
        //    object myObject = set.Next();
        //    if (myObject != null)
        //    {
        //        var tmpFeature = myObject as IFeature;
        //        if (tmpFeature != null)
        //        {
        //            if (tmpFeature.Shape != null &&
        //                !tmpFeature.Shape.IsEmpty)
        //            {
        //                poygon = tmpFeature.Shape as IPolygon;
        //            }
        //        }
        //    }
        //    return poygon;
