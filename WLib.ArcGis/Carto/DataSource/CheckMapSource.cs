...
namespace WLib.ArcGis.Carto.DataSource
{
    ...
    public class CheckMapSource
    {
        ...
        public CheckMapSource(string mapDocPath, MapSource[] mapLyrSources = null, MapSource[] mapTblSources = null)
        {
        ...
        /// <param name="mapLyrSources">地图的图层与数据源信息的对象</param>
        /// <param name="mapTblSources">地图的表格与数据源信息的对象</param>
        public CheckMapSource(IMapDocument mapDoc, MapSource[] mapLyrSources = null, MapSource[] mapTblSources = null)
        {
            MapDoc = mapDoc;
            _messages = new List<string>();
            _mapLyrSources = mapLyrSources;
        ...
        {
            CheckMapSource checkMapSource = new CheckMapSource(mapDoc, mapLyrSources, mapTblSources);
        ...
        {
            CheckMapSource checkMapSource = new CheckMapSource(mapDoc, null, null);
