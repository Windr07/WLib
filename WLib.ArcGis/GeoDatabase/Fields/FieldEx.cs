...
namespace WLib.ArcGis.GeoDatabase.Fields
{
    ...
    public static class FieldEx
    {
        ...
        /// <param name="fields"></param>
        /// <returns></returns>
        public static List<IField> ToList(this IFields fields) => fields.ToEnumerable().ToList();
        /// <summary>
        /// 将IFields转成IField数组
        /// </summary>
        /// <param name="fields"></param>
        /// <returns></returns>
        public static IField[] ToArray(this IFields fields) => fields.ToEnumerable().ToArray();
        #endregion
        ...
        /// <returns></returns>
        public static IField GetField(this IFields fields, string fieldName)
        {
            int index = fields.FindField(fieldName);
            if (index < 0) throw new Exception($"找不到字段“{fieldName}”！");
            return fields.get_Field(index);
        }
        /// <summary>
        /// 获取字段
        /// </summary>
        ...
        public static IField GetField(this ITable table, string fieldName)
        {
            ...
            if (index < 0) throw new Exception($"在表格“{table.GetName()}”中找不到字段“{fieldName}”！");
            return table.Fields.get_Field(index);
        }
        /// <summary>
        /// 获取字段
        /// </summary>
        ...
        public static IField GetField(this IFeatureClass featureClass, string fieldName)
        {
            ...
            if (index < 0) throw new Exception($"在图层“{featureClass.AliasName}”中找不到字段“{fieldName}”！");
            return featureClass.Fields.get_Field(index);
        }
        /// <summary>
        /// 查找指定类型的字段
        /// </summary>
        ...
        /// <returns></returns>
        public static List<IField> GetFields(this IFields fields, esriFieldType fieldType)
        {
        ...
        /// <param name="fieldType"></param>
        /// <returns></returns>
        public static IField GetFirstField(this IFields fields, esriFieldType fieldType)
        {
            for (int i = 0; i < fields.FieldCount; i++)
            {
                var field = fields.get_Field(i);
        ...
        /// <param name="featureClass"></param>
        /// <returns></returns>
        public static IEnumerable<IField> GetSystemFields(this IFeatureClass featureClass)
        {
            foreach (var fieldName in GetSystemFieldNames(featureClass))
            {
                var index = featureClass.FindField(fieldName);
                if (index > 0)
                    yield return featureClass.Fields.get_Field(index);
            }
        }
        /// <summary>
        /// 获取系统字段
        ...
        /// <param name="table"></param>
        /// <returns></returns>
        public static IEnumerable<IField> GetSystemFields(this ITable table)
        {
        ...
        public static int GetFieldIndex(this ITable table, string fieldName)
        {
            int index = table.FindField(fieldName);
            if (index < 0)
                throw new Exception($"在“{table.GetName()}”表格中找不到字段“{fieldName}”，请检验数据！");
            return index;
        }
        /// <summary>
        /// 查找指定字段在表格中的索引，字段不存在（索引为-1）则直接抛出异常
