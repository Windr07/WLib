...
namespace WLib.ArcGis.DataCheck.Compare.Plan
{
    ...
    public abstract class ComparePlan
    {
        ...
        {
            var fieldCompare = new FieldCompare() { FieldExpression = fieldExpression };
            fieldCompare.GetCompareFields(out var leftField, out var rightField);
            fieldCompare.LeftColumnName = leftField;
            fieldCompare.RightColumnName = rightField;
            fieldCompare.Description = fieldCompare.LeftColumnName + "不一致";
