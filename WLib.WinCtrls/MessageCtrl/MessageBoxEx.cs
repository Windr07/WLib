...
namespace WLib.WinCtrls.MessageCtrl
{
    ...
    public static class MessageBoxEx
    {
        ...
        /// <param name="helpAction">点击帮助按钮时触发的操作</param>
        public static void ShowError(Exception ex, Dictionary<string, Action> suggestionActions, Action<Exception> helpAction = null)
        ...
        /// <param name="helpAction">点击帮助按钮时触发的操作</param>
        public static void ShowError(Exception ex, string suggestion = null, Action suggestionAction = null, Action<Exception> helpAction = null)
        {
            var actions = string.IsNullOrWhiteSpace(suggestion) ? null : new Dictionary<string, Action> { { suggestion, suggestionAction } };
            new ErrorHandlerBox(ex, actions, Contacts, helpAction).ShowDialog();
        }
        /// <summary>
        /// 弹出普通的消息提示框
        ...
        public static void ShowInfo(Control owner, string info, int closeSecond = 3, EventHandler afterFormClosed = null)
