...
namespace WLib.WinCtrls.AddItemCtrl
{
    ...
    public partial class AddItemForm : Form, IMatchModeConfig
    {
        ...
        {
            var form = new AddItemConfigForm(MatchMode, RegexString, SplitStringArray);
        ...
        {
            this.移除选中项DToolStripMenuItem.Enabled = this.复制选中项ToolStripMenuItem.Enabled = this.listBoxCtrlItems.SelectedIndex > -1;
        }
