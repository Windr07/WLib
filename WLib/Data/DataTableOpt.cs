...
namespace WLib.Data
{
    ...
    public static class DataTableOpt
    {
        ...
        /// <returns></returns>
        public static DataTable CreateTable(string tableName, params string[] columnNames)
        {
        ...
        /// <param name="columnNames">列</param>
        /// <returns></returns>
        public static DataTable CreateReadOnlyTable(string tableName, params string[] columnNames)
        {
            DataTable dataTable = new DataTable();
            dataTable.TableName = tableName;
            foreach (var name in columnNames)
        ...
        /// <returns></returns>
        public static DataTable Transpose(this DataTable sourceTable)
        {
        ...
        /// <summary>
        /// 执行表连接，返回连接后的新表
        /// <para>应当通过参数<paramref name="table2Prefix"/>对连接后的新表添加字段名前缀，防止被连接的两个表之间存在同名的字段</para>
        /// <para>关于表连接可参阅：http://www.ruanyifeng.com/blog/2019/01/table-join.html </para>
        /// </summary>
        ...
        /// <param name="keyFieldType">进行相等连接字段的类型，值为null则默认为字符串类型</param>
        ...
        public static IEnumerable<IEnumerable<object>> InnerJoinToEnumerable(this DataTable table1, DataTable table2, string keyField1, string keyField2, Type keyFieldType = null)
        {
            ...
            var rows1 = table1.Rows.Cast<DataRow>();
            var rows2 = table2.Rows.Cast<DataRow>();
        ...
        /// <returns></returns>
        public static string ToText(this DataTable dataTable, string split, bool containsHeader = true)
        {
        ...
        /// <summary>
        /// 将DataTable中的数据转成JSON
        /// <para>此方法使用.net内置的<see cref="System.Web.Script.Serialization.JavaScriptSerializer"/>序列化器；
        /// 也可使用Newtonsoft.Json操作：var json = JsonConvert.SerializeObject(dataTable);</para>
        /// </summary>
        /// <param name="dataTable"></param>
        /// <returns></returns>
