...
namespace WLib.Plugins.Model
{
    ...
    [Serializable]
    public abstract class Command<TInputData, TStatusType, TStatusArgs> : Command<TInputData>, ICommand<TInputData, TStatusType, TStatusArgs>
    {
        /// <summary>
        /// 改变创建命令的对象的状态的委托
        ...
        /// </summary>
        public new Action<TStatusType, TStatusArgs> ChangedStatus { get; }
    }
}
