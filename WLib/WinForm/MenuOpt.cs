...
namespace WLib.WinForm
{
    ...
    public class MenuOpt
    {
        ...
        /// <returns></returns>
        public static ToolStripItem NewMenuItem(string text, Keys key, EventHandler onClick)
        {
            return new ToolStripMenuItem(text, null, onClick) { ShortcutKeys = Keys.Control | key };
        }
    }
}
