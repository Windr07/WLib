...
namespace WLib.Attributes.Description
{
    ...
    public static class EnumDescriptionHelper
    {
        #region 获取枚举的描述
        /// <summary>
        /// 获得指定枚举值的第一个描述，即获取附加在枚举值上的特性<see cref="DescriptionAttribute.Description"/>属性
        /// </summary>
        ...
        /// <para>即获取附加在枚举值上的特性<see cref="DescriptionAttribute.Description"/>属性，泛型T必须是枚举类型</para>
        /// </summary>
        ...
        /// <para>即获取枚举值名称和附加在枚举值上的特性<see cref="DescriptionAttribute.Description"/>属性，泛型T必须是枚举类型</para>
        /// </summary>
        ...
        /// <para>即获取枚举值对应常量和附加在枚举值上的特性<see cref="DescriptionAttribute.Description"/>属性，泛型T必须是枚举类型</para>
        /// </summary>
        /// <param name="descriptionTag">对枚举的描述的分类标签</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 获得枚举的所有枚举值对应常量和第一个描述的键值对
        /// <para>即获取枚举值和附加在枚举值上的特性<see cref="DescriptionAttribute.Description"/>属性，泛型T必须是枚举类型</para>
        /// </summary>
        /// <param name="descriptionTag">对枚举的描述的分类标签</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 获取附加在枚举值上的<see cref="DescriptionAttribute"/>特性
        /// </summary>
        /// <param name="value">枚举值</param>
        /// <returns></returns>
        ...
        #region 获取枚举值
        /// <summary>
        /// 根据枚举的第一个描述（即<see cref="DescriptionAttribute.Description"/>属性），返回枚举值，T必须是枚举类型
        /// </summary>
        ...
        /// </summary>
        /// <param name="description">指定枚举值的描述，此值应是附加在枚举值上的自定义特性<see cref="DescriptionAttribute.Description"/>属性值</param>
        /// <param name="descriptionTag">对枚举的描述的分类标签</param>
        /// <returns></returns>
