...
namespace WLib.WinCtrls.ArcGisCtrl
{
    ...
    public partial class MapViewer : UserControl
    {
        ...
        /// 是否收起的左侧TOC和鹰眼图面板
        /// </summary>
        public bool TOCCollapsed { get => this.splitContainerFull.Panel1Collapsed; set => this.splitContainerFull.Panel1Collapsed = value; }
        /// <summary>
        /// 是否收起鹰眼图面板
        /// </summary>
        public bool EagleMapCollapsed { get => this.splitContainerLeft.Panel2Collapsed; set => this.splitContainerLeft.Panel2Collapsed = value; }
        /// <summary>
        /// MapViewer控件功能的分类管理
        /// </summary>
