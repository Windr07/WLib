    ...
    public partial class WorkspaceSelector : UserControl
    {
        ...
        public string WorkspaceTypeFilter
        {
            set
            {
                ...
                this.cmbADBType.Items.AddRange(workspaceTypes.Select(v => v.GetEnum<EWorkspaceType>(2).GetDescriptionEx()).ToArray());
        ...
        public string PathOrConnStr
        {
            ...
            set
            {
                ...
                WorkspaceIndex = wsType == EWorkspaceType.Default ? 0 : this.cmbADBType.Items.IndexOf(wsType.GetDescriptionEx());
        ...
        public WorkspaceSelector()
        {
            ...
            this.SourcePathBox.OnPathTextChanged += (sender, e) =>
            {
                ...
                {
                    var index = this.cmbADBType.Items.IndexOf(wsType.GetDescriptionEx());
                    if (index > 0)
                    {
