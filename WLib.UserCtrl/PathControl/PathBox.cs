...
namespace WLib.UserCtrls.PathControl
{
    ...
    public partial class PathBox : UserControl
    {
        ...
        {
            if (OperateButtonClick != null)
                OperateButtonClick(this, new EventArgs());
        }
        /// <summary>
        /// 触发自定义路径选择事件
        /// </summary>
        ...
        {
            if (CustomizeSelectPath != null)
                CustomizeSelectPath(this, new EventArgs());
        }
