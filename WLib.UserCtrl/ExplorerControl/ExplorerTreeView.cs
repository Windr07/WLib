...
namespace WLib.UserCtrls.ExplorerControl  
{
    ...
    public partial class ExplorerTreeView : UserControl
    {
        ...
        public ShellItem SelectShellItem
        {
            get
            {
                TreeNode treeNode = this.treeWnd.SelectedNode;

                return (ShellItem) treeNode?.Tag;
            }
        }
        ...
        public string SelectPath
        {
            get
            {
                ...
                return ((ShellItem) treeNode?.Tag)?.Path;
            }
        }
        /// <summary>
        /// 刷新控件，重新加载目录结构
