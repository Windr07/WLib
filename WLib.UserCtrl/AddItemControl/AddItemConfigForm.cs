...
namespace WLib.UserCtrls.AddItemControl
{
    ...
    public partial class AddItemConfigForm : Form, IMatchModeConfig
    {
        ...
        /// </summary>
        public EMatchMode MatchMode { get { return this.radioSplitString.Checked ? EMatchMode.Split : EMatchMode.Regex; } }
        /// <summary>
        /// 正则表达式
        /// </summary>
        public string RegexString { get { return this.txtRegex.Text.Trim(); } set { this.txtRegex.Text = value; } }
        /// <summary>
        /// 默认可在下拉框中选择的分隔符
        /// </summary>
        public string[] DefaultSplitArray
        {
            get { return this.cmbFilterString.Items.Cast<string>().ToArray(); }
            set
            {
                this.cmbFilterString.Items.Clear();
                this.cmbFilterString.Items.AddRange(value);
            }
        }
        /// <summary>
        /// 分隔符数组
