...
namespace WLib.UserCtrls.AddItemControl
{
    ...
    public partial class ConcatPathForm : Form
    {
        ...
        {
            get { return this.radioConcat.Checked ? EPathSelectMode.Concat : EPathSelectMode.Filter; }
        ...
        /// 路径拼接中所指定的目录
        /// </summary>
        public string Directory { get { return this.pathBoxDir.Text; } set { this.pathBoxDir.Text = value; } }
        /// <summary>
        /// 拼接或筛选的结果（拼接后的全路径列表，或是筛选后的文件夹名/文件名）
        /// </summary>
        public string[] ResultItems { get { return this.listBoxResult.Items.Cast<string>().ToArray(); } }
