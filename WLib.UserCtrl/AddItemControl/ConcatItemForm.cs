...
namespace WLib.UserCtrls.AddItemControl
{
    ...
    public partial class ConcatItemForm : AddItemForm, IConcatStrConfig
    {
        ...
        /// 是否每一项都添加前缀和后缀
        /// </summary>
        public bool IsAddPrefixSuffix { get { return this.cbAddPrefixSuffix.Checked; } set { this.cbAddPrefixSuffix.Checked = value; } }
        /// <summary>
        /// 对每一项文本所添加前缀
        /// </summary>
        public string Prefix { get { return this.txtPrefix.Text; } set { this.txtPrefix.Text = value; } }
        /// <summary>
        /// 对每一项文本所添加后缀
        /// </summary>
        public string Suffix { get { return this.txtSuffix.Text; } set { this.txtSuffix.Text = value; } }

        /// <summary>
        /// 是否将全部项串联成一项
        /// </summary>
        public bool IsConcatAll { get { return this.cbConcatAll.Checked; } set { this.cbConcatAll.Checked = value; } }
        /// <summary>
        /// 串联每一项的连接符
        /// </summary>
        public string ConStr { get { return this.txtConStr.Text; } set { this.txtConStr.Text = value; } }
        #endregion
        ...
        /// 拼接前缀和后缀之后的每一项文本
        /// </summary>
        public string[] ConcatItems { get { return Items.Select(v => Prefix + v + Suffix).ToArray(); } }
        /// <summary>
        /// 根据连接符连接全部项之后的文本
        /// </summary>
        public string ResultString { get { return (IsAddPrefixSuffix ? ConcatItems : Items).Aggregate((a, b) => a + ConStr + b); } }
        #endregion
