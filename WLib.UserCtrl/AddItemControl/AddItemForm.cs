...
{
    /// <summary>
    /// 把输入的文本按分隔符或正则表达式筛选出所需的列表的窗体
    /// </summary>
    public partial class AddItemForm : Form, IMatchModeConfig
    {
        #region 接口属性
        /// <summary>
        ...
        /// 提示信息（默认："从以下文字中筛选："）
        /// </summary>
        public string Tip { get { return this.lblTips.Text; } set { this.lblTips.Text = value; } }
        /// <summary>
        /// 筛选所得项的提示信息（默认："获取的项："）
        /// </summary>
        public string FilterItemTip { get { return this.lblFilterItemTips.Text; } set { this.lblFilterItemTips.Text = value; } }
        /// <summary>
        /// 是否显示“筛选规则设置”按钮（设置分隔符或正则表达式）
        /// </summary>
        public bool ShowSettingButton { get { return this.sBtnSettings.Visible; } set { this.sBtnSettings.Visible = value; } }
        /// <summary>
        /// 获取的项
        /// </summary>
        public string[] Items
        {
            get { return this.listBoxCtrlItems.Items.Cast<string>().ToArray(); }
            set
            {
        ...
        public AddItemForm()
        {
            ...
            this.SplitStringArray = new string[] { Environment.NewLine };
        }
        /// <summary>
        ...
        private void EnableAddRemoveCtrl(bool enable)
        {
        ...
        {
            AddItemConfigForm form = new AddItemConfigForm(MatchMode);
            form.RegexString = RegexString;
            form.SplitStringArray = SplitStringArray;
        ...
        private void listBoxCtrlItems_SelectedIndexChanged(object sender, EventArgs e)//根据是否选择项确定启用的右键菜单
        {
            this.移除选中项DToolStripMenuItem.Enabled = this.复制选中项ToolStripMenuItem.Enabled =
                this.listBoxCtrlItems.SelectedIndex > -1;
        }

        private void 移除选中项DToolStripMenuItem_Click(object sender, EventArgs e)//移除选中项
        {
        ...
        private void 复制选中项ToolStripMenuItem_Click(object sender, EventArgs e)//复制选中项
        {
            Clipboard.SetDataObject(this.listBoxCtrlItems.SelectedItem.ToString());
        }

        private void 复制全部ToolStripMenuItem_Click(object sender, EventArgs e)//复制全部
        {
