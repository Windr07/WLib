    ...
    public partial class OleDbQueryForm : Form
    {
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    case EWorkspaceType.ShapeFile: connString = ArcGisConnStringHelper.ShapefileDir(path); break;
                    case EWorkspaceType.FileGDB: connString = ArcGisConnStringHelper.FileGdb(path); break;
                    case EWorkspaceType.Access: connString = ArcGisConnStringHelper.Access(path); break;
                }
                dbHelper = new DbHelper(connString, EDbProviderType.OleDb);
