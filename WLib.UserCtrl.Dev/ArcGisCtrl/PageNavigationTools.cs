...
{
    public partial class PageNavigationTools : UserControl
    {
        /// <summary>
        /// 页面布局导航工具类别
        /// </summary>
        public EPageTools MapTools { get; private set; } = EPageTools.None;
        /// <summary>
        /// 页面导航工具条所绑定的页面布局控件
        /// </summary>
        ...
        {
            MapTools = ((SimpleButton)sender).Text.GetEnum<EPageTools>();
