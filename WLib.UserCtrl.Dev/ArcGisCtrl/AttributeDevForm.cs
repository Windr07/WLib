...
namespace WLib.UserCtrls.Dev.ArcGisCtrl
{
    ...
    public partial class AttributeDevForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            DataTable dataTable = Table.CreateDataTable();//创建数据表
            dataTable.SwitchColumnNameAndCaption();
        ...
        public DataTable LoadAttribute(ITable table, string whereClause = null)
        {
            ...
            {
                this.Table = table;
                this.Text = ((IDataset)Table).Name + " - 属性表";
        ...
        public DataTable LoadAttribute(IFeatureLayer featureLayer, string whereClause = null)
        {
            ...
            try
            {
                ...
                string shapeTypeName = GeometryOpt.GetGeometryTypeCnName(featureLayer.FeatureClass.ShapeType);
