...
namespace WLib.UserCtrls.Dev.ArcGisControl
{
    ...
    public partial class QueryDevForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        /// 构造的查询语句
        /// </summary>
        public string WhereClause { get => this.txtWhereClause.Text.Trim();
            set => this.txtWhereClause.Text = value;
        }
        /// <summary>
        /// 查询事件
        /// </summary>
        ...
        {
            var fieldItems = FieldOpt.GetFieldItems(SearchTable, QueryFieldNames);
            this.listBoxCtrlFields.Items.AddRange(fieldItems.ToArray());
        }
