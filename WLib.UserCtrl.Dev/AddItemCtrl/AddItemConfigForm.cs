...
namespace WLib.WinCtrls.Dev.AddItemCtrl
{
    ...
    /// 数据筛选设置窗口
    /// </summary>
    public partial class AddItemConfigForm : DevExpress.XtraEditors.XtraForm, IMatchModeConfig
    {
        #region 接口属性
        /// <summary>
        ...
        public string[] DefaultSplitArray
        {
            ...
            set { this.cmbFilterString.Properties.Items.Clear(); this.cmbFilterString.Properties.Items.AddRange(value); }
        }
        /// <summary>
        /// 分隔符数组
        /// </summary>
